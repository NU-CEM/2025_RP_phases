...
def add_band(axis, bandfiles, colours, linestyles):
...
ax = add_band(ax, args.band, args.bandcolours, args.linestyles)
...
plt.savefig('phonon{}.svg'.format(args.output) if args.output is not None else 'phonon.svg')
