...
This repository contains the data and Python code required to reproduce plots in the paper [Diverse polymorphism in Ruddelsden-Popper chalcogenides]():
 ...
 - `tilt_structures`: Unrelaxed RP phases with the 33 unique tilt patterns defined by Aleksandrov applied, collected in the FHI-aims `geometry.in` format. They are generated by `construct_Aleksandrov_RP.ipynb`.
